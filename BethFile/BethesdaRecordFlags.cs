...
namespace BethFile
{
    ...
    public enum BethesdaRecordFlags : uint
    {
        ...
        IsPerch = 0x00000080,
        TES4_Localized = 0x00000080,
        PHZD_TurnOffFire = 0x00000080,

        MustUpdateAnims = 0x00000100,
        REFR_Inaccessible = 0x00000100,

        ////REFR_HiddenFromLocalMap = 0x00000200,
